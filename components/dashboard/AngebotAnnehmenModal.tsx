  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: '#F9FAFB', border: '1px solid #E5E7EB', maxHeight: '90vh', overflowY: 'auto' }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4"
          style={{ borderBottom: '1px solid #E5E7EB', background: '#F3F4F6' }}>
        ...
        <div className="px-5 py-5 space-y-4">
          ...
          <div className="rounded-xl px-4 py-3 space-y-1"
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-bold" style={{ color: '#1F2937' }}>{betrag}</span>
            </div>
            <p className="text-xs leading-snug" style={{ color: '#6B7280' }}>{betreff}</p>
          </div>
          ...
          {step === 'submitting' && (
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <p className="text-sm" style={{ color: '#6B7280' }}>Unterschrift wird übermittelt …</p>
            </div>
          )}
