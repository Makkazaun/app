...
export default function AngebotePage() {
  ...
  const filterCards: { label: string; count: number; color: string; sub: string; key: FilterKey }[] = [
    ...
    { label: 'Abgelehnt / Storniert', count: inaktiv,    color: '#C08898', sub: 'Nicht mehr gültig',       key: 'inaktiv' },
  ]
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <h1 className="text-2xl font-bold" style={{ color: '#FFFFFF' }}>Meine Angebote</h1>
            ...
            {filterCards.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs font-medium mt-0.5" style={{ color: isActive ? item.color : '#C88090' }}>
                    {item.label}
                  </p>
          ...
          {activeFilter !== null && (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                style={{ color: '#C08898', textDecoration: 'underline', textUnderlineOffset: '2px' }}
              >
                Alle anzeigen
              </button>
            </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="text-xs leading-snug pt-0.5" style={{ color: '#F5D0D5' }}>{a.betreff}</p>
                  <p className="text-sm font-semibold pt-0.5" style={{ color: '#FFFFFF' }}>
